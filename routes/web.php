...
Route::middleware('auth')->group(function () {
    ...
    Route::get('Sedrick', [\App\Http\Controllers\paulcontroller::class, 'index'])->name('Sedrick.index');
    Route::get('Sedrick/create', [\App\Http\Controllers\paulcontroller::class, 'create'])->name('Sedrick.index');
